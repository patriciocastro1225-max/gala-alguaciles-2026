...
export default function RegistrationPage() {
  ...
  function validateCurrentStep() {
    ...
    if (step === 4 && paymentChoice === "Tarjeta") { setError("EL PAGO CON TARJETA DE CRÉDITO ESTARÁ DISPONIBLE AL CONECTAR LA PASARELA DE PAGO. PARA CONTINUAR AHORA, USE TRANSFERENCIA Y ADJUNTE SU COMPROBANTE."); return false; }
  ...
  async function next() {
    ...
    try {
      ...
      if (paymentChoice === "Transferencia" && receiptFile) await uploadPaymentReceipt(receiptFile, result.attendee_id, result.portal_token);
